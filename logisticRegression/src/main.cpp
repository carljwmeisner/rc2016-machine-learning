...
int main()
{
    Data mainData("circleDataCleanRead.txt");  //set this to file containing data
    ...
    predictor.createHypothesis(.05,1,true);  // step size, number steps, include status print statments (output will get long if marked true)
